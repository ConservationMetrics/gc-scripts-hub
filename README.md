...
* Connector scripts to fetch or push data to tools such as ArcGIS, CoMapeo, Earth Index, EpiCollect5, Global Forest Watch, KoboToolbox, Local Contexts, Mapbox, ODK, Timelapse.
